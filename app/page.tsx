...
function HeroSection() {
  ...
  <FadeUp delay={0.45}>
    <p className="mt-6 mx-auto max-w-3xl text-base font light leading-8 text-white/85 md:text-lg">
      Maximize returns, minimize stress. We transform properties into elevated, thoughtfully curated luxury stays promising guaranteed income and a stress-free ownership experience.
    </p>
  </FadeUp>
